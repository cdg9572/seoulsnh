...
CLASS JHBoard extends Dbconn
{
	...
	function Board_List($args = '') {
        ...
        if (($s_date && $e_date) && ($s_date < $e_date)) {
			...
			$addQry .= " jb_etc1 BETWEEN '$s_date 00:00:00' AND '$e_date 23:59:00'";
        }

		 
        // if( $jb_code == '10' &&  $_SESSION['suserlevel'] < 9) {
		// 	$addQry .= " and A.jb_show = 'Y' ";
		// }	
       ...
       //검색 키워드 지정시
		...
		if($jb_code == 30){
			$args['q_order']		= " A.jb_order desc,  A.jb_etc16 ASC, A.jb_depth DESC,  A.jb_reg_date DESC"; // 상담게시판
		}else{
