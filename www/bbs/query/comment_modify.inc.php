...
//$jbc_content = $C_Func->enc_contents($output);
...
{
	$args = "";
    $args = array("jb_code" => $jb_code , "jb_idx" => $jb_idx, "jbc_idx" => $jbc_idx, "keys_values" => $keys_values);		
 
    
	$result_key = $C_board->BOARD_COMMENT_UPDATE($args);	
}
