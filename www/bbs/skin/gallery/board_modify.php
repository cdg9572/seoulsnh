                ...
                <tbody>
                    <tr>
                        ...
                        <td><input type="text" class="txtInput" title="제목 입력" style="width:100%;"
                                placeholder="제목을 입력해 주세요." id="jb_title" name="jb_title" value="<?=$jb_title;?>" /></td>
                    </tr>
                    <tr>
                        <th scope="row">작성자</th>
                        <td><input type="text" class="txtInput" title="작성자 입력" style="width:100%;"
                                placeholder="작성자를 입력해 주세요." id="jb_name" name="jb_name" value="<?=$jb_name?>" /></td>
                    </tr>
                    <tr>
                        <th scope="row">이메일</th>
                        <td><input type="text" class="txtInput" title="이메일 입력" style="width:100%;"
                                placeholder="이메일을 입력해 주세요." id="jb_email" name="jb_email" value="<?=$jb_email?>" /></td>
                    </tr>
                    <th scope="row">대표이미지</th>
                    <td class="files">
                        <div class="inputFile">
                            <input type="file" title="파일선택" name="jb_front_image" id="jb_front_image"
                                class="fileInput txtInput" />(278x388)
                        </div>
                        <?
                            if($jb_front_image != "") {
                                echo  $jb_front_image;
