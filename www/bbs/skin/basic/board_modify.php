            ...
            <div class="tableType-01 green">
                <table width="100%" class="writeType">
                    ...
                    <tbody>
                        <tr>
                            <th scope="row">제 목</th>
                            <td><input type="text" class="txtInput" title="제목 입력" style="width:100%;"
                                    placeholder="제목을 입력해 주세요." id="jb_title" name="jb_title" value="<?=$jb_title;?>" />
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">작성자</th>
                            <td><input type="text" class="txtInput" title="작성자 입력" style="width:100%;"
                                    placeholder="작성자를 입력해 주세요." id="jb_name" name="jb_name" value="<?=$jb_name?>" />
                            </td>
                        </tr>
                        <? if($check_level >= 9){?>
                        <!-- <tr>
                        ...
                        <td>
                            ...
                            <option value="Y" <? if($jb_show == "Y") { echo "selected"; }?>>게시</option>
                            <option value="N" <? if($jb_show == "N") { echo "selected"; }?>>비게시</option>
                            </select>
                        </td>
                        </tr> -->
                        <? } ?> 
                    ...
                    ?>
                        ...
                        <tr>
                            <th scope="row">이메일</th>
                            <td><input type="text" class="txtInput" title="이메일 입력" style="width:100%;"
                                    placeholder="이메일을 입력해 주세요." id="jb_email" name="jb_email" value="<?=$jb_email?>" />
                            </td>
                        </tr>
                        <!-- <tr>
                            <th scope="row">링크</th>
                            <td><input type="text" class="txtInput" title="링크 입력" placeholder="링크" style="width:100%;"
                                    id="jb_homepage" name="jb_homepage" value="<?=$jb_homepage?>" /></td>
                        </tr> -->
                        <tr>
                        ...
                        ?>
                            ...
                            if($ex_jb_file_name[$i]){
                                ...
                                echo " <input type=\"checkbox\" name=\"del_file[${i}]\" value=\"Y\"> <-(체크 후 수정 버튼 누르면 삭제 됩니다.)";
                            }
                            ?>
                                <?
                        }
