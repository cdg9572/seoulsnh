...
if($data_list_cnt > 0) {
	for ($i=0; $i<$data_list_cnt; $i++ ) {		
            ...
            $jb_etc6					= $data_list[$i]['jb_etc6'];
            $jb_etc7					= $data_list[$i]['jb_etc7'];
            $jb_etc8					= $data_list[$i]['jb_etc8'];
            $jb_etc9					= $data_list[$i]['jb_etc9'];
            $jb_etc10					= $data_list[$i]['jb_etc10'];
            $jb_etc11					= $data_list[$i]['jb_etc11'];
            $jb_etc12  				= $data_list[$i]['jb_etc12'];
            $jb_etc16  				= $data_list[$i]['jb_etc16'];
            ...
            $jb_type = $GP -> jb_TYPE[$jb_type];

            if($jb_etc16 == "A"){
                $jb_etc16 = '<a href="'.$get_par.'" class="btn xs bg-blue w100p">'.$GP -> jb_etc16_TYPE[$jb_etc16].'</a>';
            }
            else if($jb_etc16 == "B"){
                $jb_etc16 = '<div class="btn xs bg-gray w100p">'.$GP -> jb_etc16_TYPE[$jb_etc16].'</div>';
            }
            else if($jb_etc16 == "C"){
                $jb_etc16 = '<div class="btn xs bg-black w100p">'.$GP -> jb_etc16_TYPE[$jb_etc16].'</div>';
            }
				...
				echo ('
                        <tr>
                                   <td>'.$jb_no.'</td>
									...
									<td>
                                    ' . $jb_etc1 . ' <span>' . $jb_etc2 .':' . $jb_etc3 .'</span> ~<br>
                                    ' . $jb_etc4 . ' <span>' . $jb_etc5 .':' . $jb_etc6 .'</span>
									</td>
									<td>
									' . $jb_etc7 . ' <span>' . $jb_etc8 .':' . $jb_etc9 .'</span> ~<br>
                                    ' . $jb_etc10 . ' <span>' . $jb_etc11 .':' . $jb_etc12 .'</span>
									</td>
									<td>
                                         ' . $jb_etc16 .'
									</td>
