                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <? echo $news_select = $C_Func -> makeSelect_Normal('jb_etc5', $GP -> hour_TYPE, "23", 'class="txtInput"', '');?>시
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <? echo $news_select = $C_Func -> makeSelect_Normal('jb_etc11', $GP -> hour_TYPE, "23", 'class="txtInput"', '');?>시
                        ...
                        <!-- <tr>
                            ...
                            <td>
                                <input type="text" class="txtInput" style="width:100%;" id="jb_homepage"
                                    name="jb_homepage">
                            </td>
                        </tr> -->
                        <tr>
