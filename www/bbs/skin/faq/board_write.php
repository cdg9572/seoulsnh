            ...
            <div class="tbl-type3 resev">
                <table width="100%" class="writeType">
                    ...
                    <tbody>
                        <tr>
                            <th scope="row">작성자</th>
                            <td><input type="text" class="txtInput" style="width:100%;" title="작성자 입력"
                                    placeholder="작성자를 입력해 주세요." id="jb_name" name="jb_name" value="<?=$check_name?>" />
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">질문</th>
                            <td><input type="text" class="txtInput" style="width:100%;" title="제목 입력"
                                    placeholder="제목을 입력해 주세요." id="jb_title" name="jb_title" /></td>
                        </tr>
                        <!--tr>
          <th scope="row">작성자</th>
