...
<form name="frm_Board" id="frm_Board" action="<?=$get_par?>" method="post" enctype="multipart/form-data">
    ...
    <input type="hidden" name="jb_depth" id="jb_depth" value="<?=$jb_depth?>" />
    <input type="hidden" name="jb_group" id="jb_group" value="<?=$jb_group?>" />
                ...
                <div class="tableType-01 green">
                    <table width="100%" class="writeType">
                        ...
                        <tbody>
                            <tr>
                                <th scope="row">제목</th>
                                <td><input type="text" class="txtInput" title="제목 입력" placeholder="제목을 입력해 주세요."
                                        id="jb_title" name="jb_title" value="<?=$jb_title;?>"/></td>
                            </tr>
                            <tr>
                                <th scope="row">작성자</th>
                                <td><input type="text" class="txtInput" title="작성자 입력" placeholder="작성자를 입력해 주세요."
                                        id="jb_name" name="jb_name" value="<?=$check_name?>" /></td>
                            </tr>
                            <tr>
                                <th scope="row">이메일</th>
                                <td><input type="text" class="txtInput" title="이메일 입력" placeholder="이메일을 입력해 주세요."
                                        id="jb_email" name="jb_email" value="<?=$_SESSION['suseremail']?>" /></td>
                            </tr>
                            <?php
                            ...
                            ?>
                                                <tr>
                                                    ...
                                                    <td><input type="text" class="txtInput" title="비밀번호 입력" placeholder="비밀번호를 입력해 주세요."
                            ...
                            <!-- <tr>
                                ...
                                <td>
                                    <label><input type="checkbox" class="chk" value="Y" id="jb_secret_check"
                                            name="jb_secret_check"
                                            <?php if($jb_secret_check == "Y") echo "checked";?> /> 비밀글</label>
                                </td>
                            </tr> -->
                            <!-- <tr>
                            ...
                            <!-- <tr>
                                <th scope="row">링크</th>
                                <td><input type="text" class="txtInput" title="링크 입력" placeholder="링크" id="jb_homepage"
                                        name="jb_homepage" value="<?=$jb_homepage?>" /></td>
                            </tr> -->
                            <? if($check_level < 9 ){ ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="text" class="txt" title="자동입력방지 숫자 입력" style="width:60px;"
                                        name="zsfCode" id="zsfCode" />
                                    <a href="#;" class="btnS btnReplace"
                    ...
                    <div id="btn-box" class="center">
                        <a href="#;" id="img_submit" class="btn bg-green">답글쓰기</a>
