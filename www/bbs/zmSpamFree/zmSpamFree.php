...
if ( isset($_GET['zsfimg']) ) {
	...
	if ( !defined('zsfSessId') ) { ini_set('session.cookie_domain', '.allspine.com'); session_start(); header('Location:'.$PHP_SELF.'?zsfimg'); exit; }
	...
	if ( isset($zsfCfg['border-color']) && preg_match('#[0-9abcdef]{6}',$zsfCfg['border-color']) ) { $thisZsfCfg['border-color'] = $zsfCfg['border-color']; }
