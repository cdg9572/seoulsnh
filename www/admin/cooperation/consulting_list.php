<?php
    ...
    $excelHanArr = array(
        ...
        "기관주소3" => "tm_content4",
        "병상수" => "tm_content16",
        "감염관리실 운영 유무" => "tm_content6",
        "감염관리 전담인력 수" => "tm_content12",
        "감염관리 겸임인력 수" => "tm_content8",
        "전담기관 운영 개시일" => "tm_content9",
        "전담기관 운영 시 가동 병상 수" => "tm_content10",
        "이름" => "tm_content11",
        "근무부서" => "tm_content12",
        "감염관리실 근무 형태" => "tm_content13",
        "직위" => "tm_content18",
        "전화번호(사무실)" => "tm_content14",
        "전화번호(휴대폰)" => "tm_content7",
        "이메일" => "tm_content1",
        "비밀번호" => "tm_content2",
        "상태" => "tm_result",
    );	
...
<div class="Wrap"><!--// 전체를 감싸는 Wrap -->
		...
		<!-- <button onClick="layerPop('ifm_reg','./consulting_reg.php?tm_type=<?=$_GET['tm_type']?>', '100%', 650)"; class="btnSearch">등록</button> -->
		</div>
        ...
        <input type="hidden" name="tm_menu" id="tm_menu" value="consulting" />
							...
							<?
								...
								if($data_list_cnt > 0 ) {
									for ($i = 0 ; $i < $data_list_cnt ; $i++) {
                                        ...
                                        $tm_content11      = $data_list[$i]['tm_content11'];
                                        $tm_content15      = $data_list[$i]['tm_content15'];
										...
										$edit_btn = $C_Button -> getButtonDesign('type2','보기',0,"layerPop('ifm_reg','./consulting_edit.php?tm_idx=" . $tm_idx. "', '100%', 800)", 50,'');	
...
<script type="text/javascript">
	...
	$(document).ready(function(){	
		...
		$('#excel_btn').click(function(){
				...
				location.href = "?excel_file=consulting_list" + "&" + string;
				return false;
		});													 
