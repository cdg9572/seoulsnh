			...
			<ul>				
				...
				<li>
					...
					<select name="search_key" id="search_key">
						...
						<option value="mb_name" <?php if($_GET['search_key'] == "mb_name"){ echo "selected";}?> >성명</option>
						<option value="mb_email" <?php if($_GET['search_key'] == "mb_email"){ echo "selected";}?>>이메일</option>
					</select>
					</span>
					<span><input type="text" name="search_content" id="search_content" value="<?=$_GET['search_content']?>" class="inputSearch" size="17" /></span>
