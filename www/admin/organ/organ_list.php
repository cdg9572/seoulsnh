...
<div class="Wrap"><!--// 전체를 감싸는 Wrap -->
		...
		<button onClick="layerPop('ifm_reg','./organ_reg.php?tm_type=<?=$_GET['tm_type']?>', '100%', 650)"; class="btnSearch">등록</button>
		</div>
							...
							<?
								...
								if($data_list_cnt > 0 ) {
									for ($i = 0 ; $i < $data_list_cnt ; $i++) {
										...
										$edit_btn = $C_Button -> getButtonDesign('type2','수정',0,"layerPop('ifm_reg','./organ_edit.php?tm_idx=" . $tm_idx. "', '100%', 650)", 50,'');	
