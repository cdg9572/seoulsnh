					...
					<table class="table table-bordered">
						<tbody>                                        
                            ...
                            <tr>
                                <th>기관명</th>
								<td>
									<input type="text" class="input_text" size="50" name="tm_content3" id="tm_content3" value="<?=$tm_content3?>" />
								</td>
                            </tr>  
                            <tr>
                                <th>이미지</th>
                            ...
                            <tr>
								<th>기관주소</th>
								<td>
									<input type="text" class="input_text" size="50" name="tm_content4" id="tm_content4" value="<?=$tm_content4?>" />
								</td>
                            </tr>   
                            <tr>
                                <th>홈페이지</th>
