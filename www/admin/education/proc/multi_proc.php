...
switch($mode){	
    case 'AllDEL':
        ...
        if($rst) {
            $C_Func->put_msg_and_go("삭제 되었습니다.", $folder. "/admin/education/education_list.php?tm_menu=education&m_tab=5");
            
        }else{
            $C_Func->put_msg_and_go("삭제 실패하였습니다",$folder. "/admin/education/education_list.php?tm_menu=education&m_tab=5");
        }     
	...
	case 'MULTI_REG':
        ...
        $tm_content6 = $tm_content6_1 . "@" . $tm_content6_2 ;
        $tm_content3 = $tm_content3_1 . "-" . $tm_content3_2 . "-" . $tm_content3_3;
		...
		if($rst) {
            $C_Func->put_msg_and_go("등록되었습니다.", "/sub4/page01.html?jb_code=30&jb_mode=tdetail&jb_idx=$jb_idx");      
		}else{
