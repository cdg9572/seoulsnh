<?php
	...
	$args = "";	   
    $args = array("jb_code" => $_GET['jb_code'] );		
	$rst = $C_board -> Board_Config_Data($args);	
					...
					<table class="table table-bordered">
						<tbody>
							...
							<tr>
								...
								<td>
									<input type="radio" name="jba_comment_use" value="Y" <?php if($jba_comment_use == "Y"){ echo "checked"; }?> />사용
									<input type="radio" name="jba_comment_use" value="N" <?php if($jba_comment_use == "N"){ echo "checked"; }?> />미사용
								</td>
							</tr>		
							<tr>
								<th><span>*</span>상세페이지 하단리스트 사용유무</th>
								<td>
									<input type="radio" name="jba_list_use" value="Y" <?php if($jba_list_use == "Y"){ echo "checked"; }?> />사용
									<input type="radio" name="jba_list_use" value="N" <?php if($jba_list_use == "N"){ echo "checked"; }?> />미사용
								</td>
							</tr>	
							<tr>
