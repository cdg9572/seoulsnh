<?php
	...
	if($rst) {
        ...
        // $dr_clinic  = $C_Func->dec_contents_edit($dr_clinic);	
        // $dr_thesis  = $C_Func->dec_contents_edit($dr_thesis);
        // $dr_center  = $C_Func->dec_contents_edit($dr_center);
