<?php
	...
	$args = "";
	$args = array("pop_idx" => $_GET['pop_idx'] );	
				...
				<table class="table table-bordered">
					<tbody>
						<tr>
							...
							<td width="85%">
								<input type="text" class="inputSearch" size="25" name="pop_title" id="pop_title" value="<?=$pop_title?>" />
							</td>
						</tr>
						<tr>
								<th><span>*</span>형식</th>
						...
						<tr>
								...
								<td >
										<input type="text" class="inputSearch" size="15" name="pop_start_date" id="pop_start_date" value="<?=$pop_start_date?>" />
										 ~ 
										<input type="text" class="inputSearch" size="15" name="pop_end_date" id="pop_end_date" value="<?=$pop_end_date?>" />
								</td>
						</tr>
						<tr>
								<th><span>*</span>크기</th>
								<td >
										가로 <input type="text" class="inputSearch" size="15" name="pop_width" id="pop_width" value="<?=$pop_width?>" />px X 
										세로 <input type="text" class="inputSearch" size="15" name="pop_height" id="pop_height" value="<?=$pop_height?>" />px
								</td>
						</tr>
						<tr>
								<th><span>*</span>위치</th>
								<td >
										LEFT <input type="text" class="inputSearch" size="15" name="pop_x_position" id="pop_x_position" value="<?=$pop_x_position?>" />px X 
										TOP <input type="text" class="inputSearch" size="15" name="pop_y_position" id="pop_y_position" value="<?=$pop_y_position?>" />px
								</td>
						</tr>
						<tr>
						...
						<tr id="TR2" style="display:none;">
								<th><span>*</span>이미지</th>
								<td>
									<input type="file" name="pop_file" id="pop_file" size="30" class="inputSearch">
									<?
										if($pop_file_name != "") {
						...
						<tr id="TR3" style="display:none;">
								...
								<td>
									<input name="pop_link_url" id="pop_link_url" type="text" class="inputSearch" value="<?=$pop_link_url?>" size="50" maxlength="200">
								</td>
						</tr>  
						<tr>
