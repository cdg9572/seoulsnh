				...
				<table class="table table-bordered">
					<tbody>
						...
						<tr>
							...
							<td>
								<input type="text" class="inputSearch" size="15" name="pop_start_date" id="pop_start_date" />
								 ~ 
								<input type="text" class="inputSearch" size="15" name="pop_end_date" id="pop_end_date" />
							</td>
						</tr>
						<tr>
								<th><span>*</span>크기</th>
								<td>
										가로 <input type="text" class="inputSearch" size="15" name="pop_width" id="pop_width" />px X 
										세로 <input type="text" class="inputSearch" size="15" name="pop_height" id="pop_height" />px
								</td>
						</tr>
						<tr>
								<th><span>*</span>위치</th>
								<td>
										LEFT <input type="text" class="inputSearch" size="15" name="pop_x_position" id="pop_x_position" />px X 
										TOP <input type="text" class="inputSearch" size="15" name="pop_y_position" id="pop_y_position" />px
								</td>
						</tr>
						<tr>
								<th><span>*</span>스크롤사용여부</th>
								<td>
										<input type="radio" name="pop_scroll" value="Y" class="inputSearch" />사용
										<input type="radio" name="pop_scroll" value="N" class="inputSearch" checked="checked" />미사용
								</td>
						</tr>
						<tr id="TR1">
								<th><span>*</span>내용</th>
						...
						<tr id="TR3" style="display:none;">
								...
								<td>
									<input name="pop_link_url" id="pop_link_url" type="text" class="inputSearch" value="http://" size="50" maxlength="200">
								</td>
						</tr>  
						<tr>
