<?php
	...
	$cate2_select = $C_Func -> makeSelect_Normal('cate2', $GP -> NONPAY_CATE_TYPE1_1, $_GET['cate2'], ' title="항목2"', '::선택::');
?>
<body>
<div class="Wrap"><!--// 전체를 감싸는 Wrap -->
		...
		<div class="btnWrap">
		<button onClick="layerPop('ifm_reg','./nonpay_reg.php', '100%', 700)"; class="btnSearch btnRight">비급여 등록</button>
		</div>
						...
						<tbody>
							<?
								...
								for ($i = 0 ; $i < $data_list_cnt ; $i++) {
                                    ...
                                    $np_editdate 	= $data_list[$i]['np_editdate'];
									
									$edit_btn = $C_Button -> getButtonDesign('type2','수정',0,"layerPop('ifm_reg','./nonpay_edit.php?np_idx=" . $np_idx. "', '100%', 700)", 50,'');	
