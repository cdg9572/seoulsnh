				...
				<div class="layerTable">
					<table class="table table-bordered">
						<tbody>
                            ...
                            <tr>
								<th><span>*</span>최종변경일</th>
								<td colspan="3"><input type="text" class="input_text" size="100" name="np_editdate" id="np_editdate" value="<?=$np_editdate?>" /></td>
							</tr>							
						</tbody>
					</table>
				</div>
